...
public class ListUtilsTest {
    ...
    public void whenAddAfterBetween() {
        ...
        assertThat(Arrays.asList(0, 1, 3, 2), is(input));
    }
    ...
    public void whenRemoveIf() {
        ...
        assertThat(Arrays.asList(1, 7, 9), is(input));
    }
    ...
    public void whenReplaceIf() {
        ...
        assertThat(Arrays.asList(0, 3, 2, 3), is(input));
    }
    ...
    public void whenRemoveAll() {
        ...
        assertThat(Arrays.asList(4, 5, 9), is(input));
    }
}